      ...
      if (result === true) {
        this.memberService.deleteMember(id).subscribe(
          (data) => {
            this.getAllMember();
            this.getAllMemberLock();
            this.toastrService.showToast('success', 'Success', 'Khóa thành công');
          },
          (error) => {
            throwError(error);
            this.toastrService.showToast('danger', 'Unsuccessful', 'Khóa thất bại');
          },
        );
      }
    });
      ...
      if (result === true) {
        this.memberService.uplockMember(id).subscribe(
          (data) => {
            this.getAllMember();
            this.getAllMemberLock();
            this.toastrService.showToast('success', 'Success', 'Mở khóa thành công');
          },
          (error) => {
            throwError(error);
            this.toastrService.showToast('danger', 'Unsuccessful', 'Mở khóa thất bại');
          },
        );
      }
    });
