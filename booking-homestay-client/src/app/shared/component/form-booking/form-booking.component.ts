  ...
  ngOnInit(): void {
    ...
    this.bookingRequest = {
      ...
      this.bookingForm = new FormGroup({
        fullName: new FormControl(null, [Validators.required, Validators.maxLength(40)]),
        ...
        cs: new FormControl(false, Validators.requiredTrue),
      });
  ...
  getUserById() {
    this.profileService.getProfile().subscribe(
      (data) => {
        ...
        this.bookingForm.get('fullName').setValue(data.lastName === null ? '' : data.lastName + ' ' + data.firstName === null ? '' : data.firstName);
